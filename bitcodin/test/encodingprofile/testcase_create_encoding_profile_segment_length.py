...
class CreateEncodingProfileWithSpecificSegmentLengthTestCase(BitcodinTestCase):
    def setUp(self):
        super(CreateEncodingProfileWithSpecificSegmentLengthTestCase, self).setUp()
    ...
    def runTest(self):
        ...
        self.assertEquals(result.segment_length, 2)
