...
class CreateEncodingProfileIncompleteDataTestCase(BitcodinTestCase):
    def setUp(self):
        super(CreateEncodingProfileIncompleteDataTestCase, self).setUp()

    def runTest(self):
        audio_stream_config = AudioStreamConfig(default_stream_id=0, bitrate=192000)
        video_stream_config = VideoStreamConfig(default_stream_id=1, bitrate=512000,
                                                profile='', preset='', height=480, width=640)
    ...
    def tearDown(self):
        super(CreateEncodingProfileIncompleteDataTestCase, self).tearDown()
