...
class CreateEncodingProfileWithRotationTestCase(BitcodinTestCase):
    def setUp(self):
        super(CreateEncodingProfileWithRotationTestCase, self).setUp()
    ...
    def runTest(self):
        ...
        self.assertEquals(result.rotation, 45)

    def tearDown(self):
        delete_encoding_profile(self.encoding_profile.encoding_profile_id)
        super(CreateEncodingProfileWithRotationTestCase, self).tearDown()
